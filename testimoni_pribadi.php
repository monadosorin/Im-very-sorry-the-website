...
$_SESSION['page'] = 'testimoni_pribadi';
...
<body>
    <div class="container-fluid" style="margin-top: 30px;">
        <div class="title-row row mx-4">
            <h1 class="title"><i class="fas fa-user-secret"></i> TESTIMONI PRIBADI</h1>
        </div>
        <div class="title-row row mx-4">
                    ...
                    success: function(t) {
                        ...
                        for (var e = t, n = "", a = 1, i = 0; i < e.length; i++) {
                            ...
                            pic && ((n += "<td>" + o.nrp_penilai.toUpperCase() + "</td>"), (n += "<td>" + o.nama_penilai + "</td>")),
                                (n += "<td>" + o.acara + "</td>"),
                                (n += "<td><a type='button' style='-webkit-appearance: none;' class='btn btn-warning' data-id='" + o.id + "' data-testimoni='" + o.testimoni + "' onclick='viewTestimoni(this)'><b>View</b></a></td>"),
                        ...
                        $("#testimoniTableBody").html(n), Search($("#testimoniTable").DataTable({
                            oLanguage: {
                                sEmptyTable: "Belum Ada Testimoni Pribadi"
                            }
                        }));
                    },
                    error: function(t) {
