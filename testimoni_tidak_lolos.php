...
$_SESSION['page'] = 'testimoni_tidak_lolos';
...
<body>
    <div class="container-fluid" style="margin-top: 30px;">
        <div class="title-row row mx-4">
            <h1 class="title"><i class="fas fa-skull-crossbones"></i> TESTIMONI TIDAK LOLOS</h1>
        </div>
        <?php
    ...
    <script>
        ...
        function show() {
            $("#testimoniTableBody").html("<span>Harap tunggu...</span>"), $.ajax({
                ...
                success: function(t) {
                    ...
                    for (var e = t, n = "", a = 1, i = 0; i < e.length; i++) {
                        var o = e[i];
                        n += "<tr>", n += "<td>" + a + "</td>", n += "<td>" + o.nrp.toUpperCase() + "</td>", n += "<td>" + o.nama + "</td>", pic && (n += "<td>" + o.nrp_penilai.toUpperCase() + "</td>", n += "<td>" + o.nama_penilai + "</td>"), n += "<td>" + o.acara + "</td>", testimoni = o.testimoni.replace(/'/g, "").replace(/"/g, ""), n += "<td><a type='button' style='-webkit-appearance: none;' class='btn btn-warning' data-id='" + o.id + "' data-testimoni='" + testimoni + "' onclick='viewTestimoni(this)'><b>View</b></a></td>", n += "<td>" + o.filtered_by.toUpperCase() + "</td>", n += "</tr>", a += 1
                    }
                    $("#testimoniTableBody").html(n), Search($("#testimoniTable").DataTable({
                        oLanguage: {
                            sEmptyTable: "Belum Ada Testimoni Yang Tidak Lolos"
                        }
                    }))
                },
                error: function(t) {
